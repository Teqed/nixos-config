  ...
  config = lib.mkIf config.teq.home-manager.enable {
    home = {
      file = {
        ...
        ".config/ghostty/ghostty-shaders/my_bloom.glsl".source = ./sources/.config/ghostty/ghostty-shaders/my_bloom.glsl;
        ...
        ".config/chromium/policies/managed/defaultExtensions.json".source = ./sources/.config/chromium/policies/managed/defaultExtensions.json;
        ".config/brave/policies/managed/DisableBraveRewardsWalletAI.json".source = ./sources/.config/brave/policies/managed/DisableBraveRewardsWalletAI.json;
