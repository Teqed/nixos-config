...
in {
  options.teq.home-manager.mime-apps = {
    ...
    terminalEmulator = mkPreferenceOptions "terminal emulator" "wezterm" "wezterm.desktop";
    textEditor = mkPreferenceOptions "editor" "helix" "helix.desktop";
